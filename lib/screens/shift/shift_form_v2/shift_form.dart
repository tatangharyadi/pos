...
import 'package:pos/models/shift/v2/shift_repository.dart';
// import 'package:pos/screens/shift/shift_form_v2/shift_shifts_tab.dart';
                            ...
                            children: [
                              Expanded(
                                child: FormBuilderDateTimePicker(
                                  ...
                                  initialValue: parentShift?.startTime ?? _initialValue.startTime,
                                ),
                              ),
                              const Gap(5),
                              Expanded(
                                child: FormBuilderDateTimePicker(
                                  ...
                                  inputType: InputType.time,
                                  format: DateFormat('HH:mm'),
                                  initialValue: parentShift?.endTime ?? _initialValue.endTime,
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: FormBuilderDateTimePicker(
                                  ...
                                  initialValue: parentShift?.startDate ?? _initialValue.startDate,
                                ),
                              ),
                              const Gap(5),
                              Expanded(
                                child: FormBuilderDateTimePicker(
                                  ...
                                  inputType: InputType.date,
                                  format: DateFormat('yyyy-MM-dd'),
                                  initialValue: parentShift?.endDate ?? _initialValue.endDate,
                                ),
                              ),
                            ],
                          ),
